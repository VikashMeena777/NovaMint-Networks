...
import { Mail, Loader2, ArrowLeft, Check, KeyRound, AlertCircle } from 'lucide-react';
...
function ForgotPasswordForm() {
        ...
        return (
            <SpotlightCard className="p-8 sm:p-10 bg-[#08090C]/90 border-white/[0.08] shadow-2xl text-center">
                ...
                <p className="text-xs text-neutral-400 mb-8 leading-relaxed">
                    We've sent a password reset link to <strong className="text-white font-mono">{email}</strong>.
    ...
    return (
        <SpotlightCard className="p-8 sm:p-10 bg-[#08090C]/90 border-white/[0.08] shadow-2xl">
            ...
            {initialError && (
                <div className="mb-5 p-3.5 rounded-xl bg-red-500/10 border border-red-500/20 text-xs text-red-300 flex items-start gap-2.5">
