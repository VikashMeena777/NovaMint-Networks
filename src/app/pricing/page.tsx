...
const faqs = [
    { question: 'What payment methods do you accept?', answer: 'We accept all major payment methods including UPI, credit/debit cards, net banking, wallets, and international cards via Cashfree.' },
    { question: 'Can I upgrade or downgrade my plan?', answer: 'Yes! You can change your plan at any time. Upgrades take effect immediately, and downgrades apply at the next billing cycle.' },
    { question: 'Do you offer refunds?', answer: "Due to the nature of digital services, we don't offer refunds. However, we provide unlimited revisions until you're satisfied." },
    { question: "What's the turnaround time?", answer: 'Standard delivery is 2–3 days. Pro plan members get priority 24-hour delivery on most projects.' },
    { question: 'Can I get custom pricing?', answer: 'Absolutely! For enterprise needs or custom requirements, contact us for a tailored quote.' },
];
